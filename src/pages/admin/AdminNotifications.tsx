...
import { getAdminNotifications, markAdminNotificationRead, deleteAdminNotification } from '../../services/notificationService'
    ...
    <Layout>
      <AnimatedPage>
        <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-100">Admin Notifications</h1>
            <p className="text-slate-400">Administrative alerts for issue cleanup and inactive reports.</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {notifications.map((notification) => (
              <div
                key={notification.id}
                className={`glass-card p-4 transition duration-200 ${notification.read ? 'opacity-70' : 'shadow-[0_0_30px_rgba(59,130,246,0.15)]'}`}
              >
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="btn-ghost rounded-xl px-4 py-2 text-sm text-rose-300"
                    >
                      Delete
                    </button>
                  </div>
